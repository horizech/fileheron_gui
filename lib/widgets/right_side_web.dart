...
class RightSideWeb extends StatefulWidget {
  int view;
  final Function(String)? callback;
  RightSideWeb({Key? key, required this.view, required this.callback})
      : super(key: key);

  @override
  State<RightSideWeb> createState() => _RightSideWebState();
}

class _RightSideWebState extends State<RightSideWeb> {
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Align(alignment: Alignment.topCenter, child: mainScreen()),
        ),
      ),
    );
  }
  ...
  Widget localServer() {
    return SizedBox(
      ...
      child: Form(
        key: _formKey,
        child: UpCard(
          style: UpStyle(cardHeight: MediaQuery.of(context).size.height - 68),
